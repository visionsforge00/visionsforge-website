      (function () {
        ...
        if (
          ...
          // Same reasoning as background-canvas.js: this is an O(n^2)
          // per-frame 3D point animation, expensive to keep running on
          // mobile CPUs. CSS supplies a static glow fallback (#hc).
